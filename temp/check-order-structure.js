...
async function checkOrderStructure() {
  try {
    ...
    console.log(
      "Orders with embedded LR:",
      ordersWithEmbeddedLR,
      `(${((ordersWithEmbeddedLR / totalOrders) * 100).toFixed(1)}%)`
    );
    console.log(
      "Orders with embedded Invoices:",
      ordersWithEmbeddedInvoices,
      `(${((ordersWithEmbeddedInvoices / totalOrders) * 100).toFixed(1)}%)`
    );
    ...
    if (totalLRs > 0) {
      ...
      console.log(
        "Orders in last 30 days with LR:",
        ordersInRangeWithLR,
        `(${((ordersInRangeWithLR / totalOrders) * 100).toFixed(1)}%)`
      );
    }
    ...
    if (totalInvoices > 0) {
      ...
      console.log(
        "Orders in last 30 days with Invoice:",
        ordersInRangeWithInvoice,
        `(${((ordersInRangeWithInvoice / totalOrders) * 100).toFixed(1)}%)`
      );
    }
